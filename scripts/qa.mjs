...
for (const disclosure of ["DevAwesome and Contextter are operated by Matthias Ramahi", "are not independent recommendations"]) if (!home.includes(disclosure)) failures.push("home must disclose common ownership beside Contextter workflow links: " + disclosure);
