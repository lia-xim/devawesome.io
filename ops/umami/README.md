...
- `prune-devawesome-analytics.sh` deletes raw DevAwesome analytics rows older than 14 months. It does not delete saved reports, website settings, users, teams, or data for another website.
