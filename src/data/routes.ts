...
export const canonicalRoutes: CanonicalRoute[] = [
  ...
  { path: "/tools/robots-txt-tester", title: "Robots.txt Tester", description: "Test one crawler user-agent and URL path against pasted robots.txt rules locally in your browser.", job: "Check which pasted robots.txt rule applies to one crawler and path.", cluster: "tools", searchEligible: true, evidence: "experiment" },
  ...
  { path: "/tools/mcp-json-rpc-validator", title: "MCP JSON-RPC Validator", description: "Validate JSON-RPC 2.0 envelopes, MCP tools/list payloads, and MCP tool definitions locally in your browser.", job: "Find structural errors in an MCP JSON-RPC payload or tool definition.", cluster: "tools", searchEligible: true, evidence: "experiment" },
