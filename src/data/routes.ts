...
export const canonicalRoutes: CanonicalRoute[] = [
  { path: "/", title: "DevAwesome Developer Tools", description: "Small browser-local developer tools for JSON, UUIDs, SHA-256 hashes, and test planning.", job: "Choose and use a small developer tool immediately.", cluster: "home", searchEligible: true, evidence: "verified" },
  ...
  { path: "/tools", title: "Developer Tools", description: "Free browser-local tools for JSON, UUIDs, SHA-256 hashes, and developer test plans.", job: "Browse the available browser-local developer tools.", cluster: "tools", searchEligible: true, evidence: "verified" },
  { path: "/tools/json-formatter", title: "JSON Formatter", description: "Format, validate, and minify JSON locally in your browser without uploading it.", job: "Format or minify JSON and identify syntax errors.", cluster: "tools", searchEligible: true, evidence: "experiment" },
  ...
  { path: "/tools/developer-tool-test-plan", title: "Developer Test Plan Builder", description: "Create and export a clear JSON test plan for a developer tool, API, or workflow.", job: "Create a reusable JSON test plan without sending data to a server.", cluster: "tools", searchEligible: true, evidence: "experiment" },
