...
export const canonicalRoutes: CanonicalRoute[] = [
  ...
  { path: "/tools/evidence-receipt", title: "SHA-256 Evidence Receipt", description: "Generate and export a browser-local SHA-256 receipt for normalized UTF-8 text without uploading the evidence.", job: "Fingerprint permitted text evidence and keep the proof limits attached.", cluster: "tools", searchEligible: true, evidence: "experiment" },
